...
export default function Toolbar() {
  return (
    <div className="fixed px-5 right-0 top-13 flex gap-5 scrollbar-hide overflow-scroll w-full py-1 z-10 backdrop-blur-2xl bg-transparent md:justify-center print:hidden">
      <AddSection />
      <UndoRedo />
      <Zoom />
      <FontSelector />
