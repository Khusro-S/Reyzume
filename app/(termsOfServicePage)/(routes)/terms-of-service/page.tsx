        ...
        <div className="space-y-8">
          ...
          <section className="space-y-4">
            ...
            <p className="text-[#4B5563] leading-relaxed">
              By accessing and using Reyzume ("the Service"), you accept and
          ...
          <section className="space-y-4">
            ...
            <p className="text-[#4B5563] leading-relaxed">
              Reyzume is a web-based resume builder that allows users to create,
              edit, and export professional resumes. The Service is provided
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              <h3 className="text-xl font-medium text-[#111827]">Ownership</h3>
              <p className="text-[#4B5563] leading-relaxed">
            ...
            <div className="space-y-3">
              ...
              <p className="text-[#4B5563] leading-relaxed">
                ...
                content you create. You agree not to:
              </p>
              <ul className="list-disc list-inside text-[#4B5563] space-y-2 pl-4">
          ...
          <section className="space-y-4">
            ...
            <p className="text-[#4B5563] leading-relaxed">
              ...
              . The Service's design, logos, and branding remain the property of
              the project creator.
            </p>
          </section>
